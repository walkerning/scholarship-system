<template>
  <section>
    <h1>{{ hasPermissionScholar? "奖学金编辑": "奖学金查看" }}</h1>
    <!--工具条-->
	...
	<el-form-item v-if="hasPermissionScholar">
	...
	<template scope="scope">
          <template v-if="hasPermissionScholar">
	    ...
	    <el-button size="small" @click="singleScholarshipCopy(scope.$index, scope.row)">从该奖学金创建</el-button>
          ...
          <template v-else>
            <el-button size="small" @click="singleScholarshipEdit(scope.$index, scope.row)">查看</el-button>
          </template>
	</template>
      </el-table-column>
    </el-table>
    ...
    <el-col :span="24" class="toolbar">
      <el-button type="danger" @click="allScholarshipBatchRemove" :disabled="this.scholarshipSels.length===0" v-if="hasPermissionScholar">批量删除</el-button>
	...
	<el-form-item label="奖学金名" prop="name">
	  <el-input v-model="scholarshipEditForm.name" auto-complete="off" :disabled="!hasPermissionScholar"></el-input>
	</el-form-item>
	<el-form-item label="年份" prop="year">
	  <el-input v-model="scholarshipEditForm.year" auto-complete="off" :disabled="!hasPermissionScholar"></el-input>
	</el-form-item>
	<el-form-item label="感谢信表单">
	  <el-select v-model="scholarshipEditForm.form_id" :disabled="!hasPermissionScholar">
	...
	<el-form-item label="分配方式">
	  <el-select v-model="scholarshipEditForm.alloc" :disabled="!hasPermissionScholar">
	...
	<template v-if="scholarshipEditForm.alloc === _SCHOLARSHIP_ALLOC_TYPE.QUOTA">
	  <el-form-item label="每人金额（元）">
	    <el-input-number v-model="scholarshipEditForm.money" :min="0" :disabled="!hasPermissionScholar"></el-input-number>
	  </el-form-item>
	  <el-form-item label="各年级名额">
	    <template v-for="(group_quota, index) in scholarshipEditForm.group_quota">
	      <el-row>
		<div style="width:150px;float:left;">
		  年级：<el-input v-model="group_quota.group" :disabled="!hasPermissionScholar"></el-input>
		</div>
		<div style="width:150px;float:left;">
		  类别：
		  <el-select v-model="group_quota.type" :disabled="!hasPermissionScholar">
		...
		<div style="width:200px;float:left;">
		  名额：<br /> <el-input-number v-model="group_quota.quota" :min="0" :disabled="!hasPermissionScholar"></el-input-number>
		</div>
		<div style="width:150px;float:left;" v-if="hasPermissionScholar">
		  操作：<br /><el-button type="danger" @click="scholarshipEditForm.group_quota.splice(index, 1)" :disabled="!hasPermissionScholar">删除</el-button>
		</div>
	      </el-row>
	    </template>
	    <el-row v-if="hasPermissionScholar">
	...
	<template v-else-if="scholarshipEditForm.alloc === _SCHOLARSHIP_ALLOC_TYPE.MONEY">
      ...
      <div slot="footer" class="dialog-footer" v-if="hasPermissionScholar">
